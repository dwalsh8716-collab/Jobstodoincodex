import type { CaseStudy, FAQ, Insight, Job, RichMedia, SalarySnapshot, Service } from "./types";
...
export const specialisms = [
  {
    ...
    description: "CMO, Marketing Director, Head of Marketing and senior growth leadership roles."
  },
  {
    title: "PR & Communications",
    description: "Senior PR, communications, reputation, social, content and earned media talent."
  },
  {
    title: "Digital & Performance",
    description: "Digital, performance, eCommerce, CRM, analytics and demand generation specialists."
  },
  {
    title: "Social & Content",
    description: "People who can connect channel craft, brand thinking and audience attention."
  },
  {
    title: "Client Services",
    description: "Agency-side client leadership, account direction and commercially mature relationship roles."
  },
  {
    title: "Growth & Commercial",
    description: "Senior hires who connect positioning, pipeline, revenue, customer growth and commercial rhythm."
  },
  {
    title: "Agency Operations",
    description: "Operational and leadership roles that help agencies run better, not just look busier."
  }
];
...
export const services: Service[] = [
  {
    ...
    heroHeadline: "Leadership search for marketing, communications and agency leaders.",
    heroSubheadline:
      "Senior roles shape growth, culture and commercial performance. Search needs proper briefing, market mapping, candidate engagement and process management.",
    audience: ["Founders", "CEOs", "MDs", "CMOs", "Marketing Directors", "Agency leaders"],
    problemsSolved: [
    ...
    faqs: serviceFaqs,
    relatedInsightSlugs: ["when-should-an-agency-use-retained-search", "why-senior-marketing-hiring-goes-wrong"],
    relatedCaseStudySlugs: ["independent-pr-agency-senior-account-director"],
    cta: { label: "Talk through a leadership brief", href: "/contact", variant: "primary" },
  ...
  },
  {
    ...
    heroHeadline: "Senior marketing and agency leadership without another full-time salary.",
    heroSubheadline:
      "Strategic Interim brings experienced senior operators into the business on a flexible basis to solve a defined problem, build capability or create momentum.",
    audience: ["Founders", "MDs", "CMOs", "Agency owners", "Growth businesses", "Post-investment teams"],
    problemsSolved: [
    ...
    relatedInsightSlugs: ["what-is-a-strategic-interim-marketing-leader", "strategic-interim-vs-consultant"],
    relatedCaseStudySlugs: ["integrated-agency-strategic-interim"],
    cta: { label: "Discuss a Strategic Interim brief", href: "/contact", variant: "primary" },
  ...
  },
  {
    ...
    heroHeadline: "Agency recruitment for people who can handle the pace, the clients and the commercial pressure.",
    heroSubheadline:
      "Agency hiring is not just title matching. Strong candidates need to handle clients, ambiguity, pace, pressure and culture.",
    audience: ["Agency founders", "Agency MDs", "Client services leaders", "PR and digital agency teams"],
    problemsSolved: [
    ...
    faqs: serviceFaqs,
    relatedInsightSlugs: ["how-agencies-should-hire-senior-pr-and-communications-talent"],
    relatedCaseStudySlugs: ["independent-pr-agency-senior-account-director"],
    cta: { label: "Talk through an agency brief", href: "/contact", variant: "primary" },
  ...
  },
  {
    ...
    shortDescription: "Senior marketing and communications recruitment for brands and growth businesses.",
    heroHeadline: "Client-side marketing recruitment for brands and growth businesses.",
    heroSubheadline:
      "For in-house teams that need marketers who can own outcomes, not just channels.",
    audience: ["CMOs", "Marketing Directors", "People leaders", "CEOs", "Growth businesses"],
    problemsSolved: [
    ...
    faqs: serviceFaqs,
    relatedInsightSlugs: ["how-to-hire-a-marketing-director-without-wasting-six-weeks"],
    relatedCaseStudySlugs: ["growth-brand-head-of-marketing"],
    cta: { label: "Talk through a client-side brief", href: "/contact", variant: "primary" },
  ...
  },
  {
    ...
    heroHeadline: "Senior marketing and comms recruitment without the recruitment nonsense.",
    heroSubheadline:
      "For mid-to-senior roles where the wrong hire creates noise, delay and avoidable commercial pain.",
    audience: ["Agency leaders", "Brands", "Growth businesses", "Marketing teams", "People leaders"],
    problemsSolved: [
    ...
    faqs: serviceFaqs,
    relatedInsightSlugs: ["why-good-marketing-candidates-are-not-applying-to-your-job"],
    relatedCaseStudySlugs: [],
    cta: { label: "Discuss a senior role", href: "/contact", variant: "primary" },
    seoTitle: "Senior Marketing & Communications Recruitment | Essential Resourcing",
    metaDescription:
...
export const insights: Insight[] = [
  {
    ...
    pullQuote: "Consultants often tell you what the problem is. A Strategic Interim helps fix it.",
    faqs: [
      {
    ...
    seoTitle: "What is a Strategic Interim Marketing Leader? | Essential Resourcing",
    metaDescription:
  ...
  },
  {
    ...
    seoTitle: "When Should an Agency Use Retained Search? | Essential Resourcing",
    metaDescription:
  ...
  },
  {
    ...
    relatedServiceSlugs: ["leadership-search", "client-side-marketing-recruitment"],
    relatedInsightSlugs: ["how-to-hire-a-marketing-director-without-wasting-six-weeks"],
  ...
  },
  {
    ...
    relatedServiceSlugs: ["client-side-marketing-recruitment", "leadership-search"],
    relatedInsightSlugs: ["why-senior-marketing-hiring-goes-wrong"],
...
export const salarySnapshots: SalarySnapshot[] = [
  ...
  },
  {
    ...
    commentary: ["Agency and client-side PR titles need careful comparison before salary ranges are published."],
    rows: [
      { role: "Senior Account Director", low: "To validate", mid: "To validate", high: "To validate", notes: "Agency-side range to confirm." },
      { role: "Communications Lead", low: "To validate", mid: "To validate", high: "To validate", notes: "Client-side range to confirm." }
    ],
    hiringNotes: ["Separate press office, corporate comms, content and strategic communications expectations."],
...
export const jobs: Job[] = [
  {
    ...
    metaDescription: "Draft job page structure for a Senior Account Director role. Not a live vacancy."
  }
];
...
export function getInsight(slug: string) {
  return insights.find((insight) => insight.slug === slug && insight.status === "published");
}
