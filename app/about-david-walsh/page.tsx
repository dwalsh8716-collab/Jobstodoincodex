  ...
  return (
    <>
      ...
      <section className="section dark">
        <div className="container split">
          <div>
            ...
            <p className="lede">
              David brings over a decade of specialist recruitment judgement
              across agencies, brands, marketing teams, PR, communications,
              digital and senior leadership hiring.
            </p>
        ...
        <div className="container split split-start">
          ...
          <div className="article-body">
            <section>
              ...
              <p>
                David challenges briefs where needed. That means talking plainly
                about salary, process, candidate availability and whether the
                market will actually buy what the client is selling.
              </p>
            </section>
            <section>
              <h3>Long-term candidate relationships</h3>
              <p>
                Candidates are treated like people, not inventory. No pointless
                CV sending. No pushing people into roles that are wrong for
                them.
              </p>
            </section>
            <section>
              ...
              <p>
                The business has a strong Manchester and North West point of
                view, but the work is not provincial. Senior marketing and comms
                hiring is UK-wide when the brief needs it.
              </p>
            </section>
          </div>
        </div>
      ...
      <CTASection
        ...
        text="Tell David what you are trying to hire and he will tell you honestly whether he can help."
      />
    </>
  );
}
